...
package mine.plugins.lunar.expbalance.custom_block_data;
...
public class CustomBlockData implements PersistentDataContainer {
     ...
     * @param plugin Plugin
     */
    public CustomBlockData(final @NonNull Block block, final @NonNull Plugin plugin) {
    ...
    private static Map.Entry<UUID, BlockVector> getBlockEntry(final @NonNull Block block) {
     ...
     */
    @Deprecated
    public CustomBlockData(final @NonNull Block block, final @NonNull String namespace) {
        this.chunk = block.getChunk();
     ...
     */
    @NonNull
    static String getKey(@NonNull final Block block) {
     ...
     * when a player breaks this block. It will additionally call custom events like.
     ...
     */
    @NonNull
    private static Set<Block> getBlocksWithCustomData(final @NonNull Chunk chunk, final @NonNull NamespacedKey namespace) {
        final PersistentDataContainer chunkPDC = chunk.getPersistentDataContainer();
